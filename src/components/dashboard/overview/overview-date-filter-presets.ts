...
export function getOverviewDateFilterPresets(
  ...
  return [
    {
      label: t("date_filter_preset_today"),
      values: createOverviewDateFilterValues(referenceDate),
    },
    {
      label: t("date_filter_preset_yesterday"),
      values: createOverviewDateFilterValues(previousDay),
    },
    {
      label: t("date_filter_preset_this_week"),
    ...
    {
      label: t("date_filter_preset_last_week"),
      values: createOverviewDateFilterValues(
    ...
    {
      label: t("date_filter_preset_this_month"),
      values: createOverviewDateFilterValues(
    ...
    {
      label: t("date_filter_preset_last_month"),
      values: createOverviewDateFilterValues(
